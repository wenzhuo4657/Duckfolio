  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1 rounded-md">
        ...
        >
          <code className="block size-full ">
            <textarea
              ref={textareaRef}
              value={internalCode}
              onChange={handleChange}
              readOnly={readOnly}
              className="m-0 size-full  resize-none overflow-auto border-0 bg-transparent p-0 font-mono text-sm outline-none"
